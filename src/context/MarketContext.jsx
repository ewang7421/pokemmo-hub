...
export function MarketProvider({ children }) {
  ...
  const addToInvestments = (investment) => {
    console.log("old: ")
    console.log(market.investments);
    let updatedInvestments = new Map();
    if(market.investments){
        updatedInvestments = new Map(updatedInvestments);
    }
    const targetItemInvestment = market.investments.get(investment.i);
    const currentEntry = {
      id: investment.id,
      quantity: investment.quantity,
      boughtPrice: investment.boughtPrice,
    };
    updatedInvestments.set(
      investment.i,
      targetItemInvestment
        ? [...targetItemInvestment, currentEntry]
        : [currentEntry]
    );
    updateAccount({
      market: {
